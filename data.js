// data.js — seed data + helpers for the Coastal Ledger
// Plain script (no JSX), exposes on window.LedgerData
...
(function () {
  ...
  const today = new Date(2026, 4, 25); // May 25, 2026 — fixed for the demo

  // ── Envelopes (monthly budget categories) ─────────────────────────────
  const envelopes = [
  ...
  // ── Debts ──────────────────────────────────────────────────────────────
  const debts = [
    { id: 'd1', name: 'Student Loan',  balance: 14200, original: 22000, apr: 5.4,   minPay: 220, strategy: 'snowball', icon: '🎓' },
    { id: 'd2', name: 'Credit Card',   balance: 2300,  original: 3800,  apr: 22.99, minPay: 75,  strategy: 'avalanche', icon: '💳' },
    { id: 'd3', name: 'Car Loan',      balance: 9800,  original: 18000, apr: 4.5,   minPay: 310, strategy: 'snowball', icon: '🚗' },
  ];
  ...
  window.LedgerData = {
    seed: { envelopes, bills, goals, debts, txns },
    fmt, fmtShort, monthKey, today, deriveTotals, parseCSV,
  };
})();

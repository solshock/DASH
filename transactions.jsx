// transactions.jsx — ledger view with CSV import + manual add
// Exposes: TransactionsView

function TransactionsView({ state, setState, onAddTxn }) {
  const { fmt, parseCSV } = window.LedgerData;
    ...
    <div className="pane">
      <div className="page-hd">
        <div>
          ...
          <h1>Ledger</h1>
          <div className="lede">
            Every wave that hit the shore this month. Import from your bank's CSV or log them by hand.
          </div>
        </div>
      ...
      <div className="card">
        <div className="card-hd" style={{ flexWrap: 'wrap', gap: 12 }}>
          <div className="row" style={{ gap: 6 }}>
            ...
            <select className="field" style={{ height: 28, padding: '0 8px', borderRadius: 6, marginLeft: 8, background: 'rgba(255,255,255,0.04)', color: 'var(--ink)', border: '1px solid var(--line-2)', fontSize: 11 }} value={filter} onChange={(e) => setFilter(e.target.value)}>
          ...
          <input
            ...
            style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid var(--line-2)', borderRadius: 6, color: 'var(--ink)', padding: '6px 10px', fontSize: 12, width: 220, fontFamily: 'inherit', outline: 'none' }}
          />
        </div>
        ...
        <div style={{ marginTop: 12, padding: 12, borderTop: '1px dashed var(--line)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 11, color: 'var(--ink-3)', fontFamily: 'JetBrains Mono, monospace' }}>
...
Object.assign(window, { TransactionsView });
